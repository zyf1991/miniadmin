...
class Addsigntable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sign', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_sign')->default(0)->comment('是否签到 0未签到 1签到');
            $table->string('sign_text',255)->nullable($value = true)->comment('打卡内容');
            $table->json('sign_image',255)->nullable($value = true)->comment('打卡图片');
